            ...
            <form class="form-horizontal" role="form" method="POST" action="{{route('group.store')}}">
                ...
                <div class="form-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control input"  value="{{old('groupname')}}" name="groupname" >
                        </div>
                    </div>
                </div>
                ...
                <div class="form-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control input"  value="{{old('description')}}" name="description" >
                        </div>
                    </div>
                </div>
                <div class="form-body">
                ...
                <div class="form-actions right1">
                    ...
                    <button type="button" id="closeCreate" class="btn btn-danger" data-dismiss="modal">Close</button>
                </div>
            </form>
        </div>
    </div><!-- panel -->
