                ...
                <form class="form-horizontal" role="form" method="PATCH" action="{{route('group.store',$group->id)}}">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control input"  value="{{$group->groupname}}" name="groupname"  >
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control input"  value="{{$group->description}}" name="description" >
                            </div>
                        </div>
                    </div>
                    <div class="form-body">
