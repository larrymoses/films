                ...
                <form class="form-horizontal" role="form" method="post" action="{{route('config')}}">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control input" VALUE="{{old('configname')}}" placeholder="Config Name" name="configname">
                            </div>
                        </div>
                    </div>
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control input" VALUE="{{old('configvalue')}}" placeholder="Config Value" name="configvalue">
                            </div>
                        </div>
                    </div>
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="tel" class="form-control input" VALUE="{{old('description')}}" placeholder="Description" name="description">
                            </div>
                        </div>
                    </div>
