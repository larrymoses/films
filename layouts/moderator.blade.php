...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/js/datatables/media/assets/css/datatables.min.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{asset('assets/js/datatables/extras/TableTools/media/css/TableTools.min.css')}}" />
            ...
            <ul class="page-sidebar-menu  page-header-fixed page-sidebar-menu-hover-submenu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                ...
                <li class="nav-item ">
                    <a href="{{url('moderator/new')}}" class="nav-link nav-toggle">
                        ...
                        <span class="title">Unrated Film</span>
                    </a>
                </li>
            </ul>
            <!-- END SIDEBAR MENU -->
